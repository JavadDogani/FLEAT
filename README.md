...
Compared with a single monolithic script, this version is easier to:

- maintain
- test
- reuse in papers and GitHub repositories
- extend with new datasets or models
- swap controllers or aggregation rules
- debug local failures without touching the whole codebase

## Notes on compatibility

This refactoring was intentionally written to preserve the original logic as closely as possible:

- same CLI options
- same round structure
- same controller update style
- same pruning and masking behavior
- same aggregation rules
- same output format philosophy
- same alpha-sweep workflow

So the project is reorganized, but the **experimental meaning** stays the same.

## Suggested GitHub description

**FLEAT Project** is a modular simulation-first federated learning benchmark runner implementing adaptive local-step control, masked uploads, energy-aware scheduling, and paper-style evaluation for FLEAT and related baselines.

## Suggested repository topics

`federated-learning`, `distributed-learning`, `edge-ai`, `energy-aware-ai`, `pytorch`, `federated-optimization`, `non-iid-learning`, `multi-gpu`, `simulation`, `benchmarking`
...
If this code accompanies a paper, add your paper citation here once the manuscript title and venue are finalized.
